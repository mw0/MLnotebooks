...
st.sidebar.info(
    ...
    "If the 'Autocorrect' checkbox is selected, a BERT transformer model is applied "
    "to the text in an attempt to sensibly replace character and spacing misreads. "
    "In practice, this does not make fixes that a human might, but it does make for"
    " cleaner usage in some cases.\n\n"
...
autocorrect = False
autocorrect = st.sidebar.checkbox("Autocorrect (BERT transformer)", value=True)
